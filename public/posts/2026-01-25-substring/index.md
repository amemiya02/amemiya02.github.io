...
若对每个窗口都遍历求最大值，时间复杂度为 $O(nk)$，在 `k` 较大时会超时（`n = 10^5` 级别）。我们需要一种能“快速淘汰无用元素 + 快速获取最大值”的数据结构。
...
> 作者:   
> URL: https://amemiya02.github.io/posts/2026-01-25-substring/  
